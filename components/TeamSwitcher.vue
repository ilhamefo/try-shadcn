    ...
    <Popover v-model:open="open">
      <PopoverTrigger as-child>
        <Button
          ...
          :class="cn('w-[200px] justify-between dark:text-slate-50 dark:hover:text-slate-300', $attrs.class ?? '')"
        >
          ...
          {{ selectedTeam.label }}
          <SelectIcon class="ml-auto h-4 w-4 shrink-0 opacity-50" />
        </Button>
      </PopoverTrigger>
